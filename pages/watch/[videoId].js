...
export default function WatchPage() {
    ...
    // --- [ ✅ التعديل هنا: التوافق مع الأندرويد ] ---
    useEffect(() => {
    ...
    const opts = { playerVars: { autoplay: 0, controls: 0, rel: 0, showinfo: 0, modestbranding: 1, disablekb: 1, fs: 1 }, }; // fs: 1 للسماح بملء الشاشة
        ...
        <div className="page-container">
            ...
            <div className="player-wrapper">
                ...
                <div className="controls-overlay">
                    ...
                    {/* ✅ العلامة المائية ستعرض الاسم الحقيقي الآن */}
