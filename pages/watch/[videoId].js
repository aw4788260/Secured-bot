...
// =========================================================================
// 1. مكون العلامة المائية (مأخوذ من كودك الثاني - لوضع اليوتيوب)
// =========================================================================
...
// =========================================================================
// 2. الصفحة الرئيسية (تجمع المنطقين)
// =========================================================================
export default function WatchPage() {
    ...
    const [viewMode, setViewMode] = useState(null); // 'native' (OfflineOn) or 'youtube' (OfflineOff)
    ...
    // 1. التعرف على المستخدم (منطق موحد)
    useEffect(() => {
    ...
    useEffect(() => {
        ...
        art.on('ready', () => {
            // منطق العلامة المائية الخاص بـ Artplayer
        ...
        <div className="page-container">
            ...
            <div className="player-wrapper" ref={playerWrapperRef}>
                ...
                {viewMode === 'youtube' && !loading && (
                    <>
                        <Plyr 
                            key={videoData?.youtube_video_id} // لإجبار إعادة التحميل
                            source={plyrSource} 
                            options={plyrOptions} 
                        />
