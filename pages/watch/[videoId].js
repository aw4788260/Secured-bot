...
// =========================================================================
// 3. مكون مشغل Artplayer (للموبايل فقط - الوضع Native)
// =========================================================================
...
// =========================================================================
// 4. مكون مشغل Plyr (للكمبيوتر والوضع الأونلاين) - مع الستارة والحماية
// =========================================================================
const YoutubePlyrPlayer = ({ videoData, user }) => {
    const plyrRef = useRef(null);
    // حالة لتتبع توقف الفيديو لإظهار الستارة
    ...
    // مراقبة أحداث المشغل للتحكم في الستارة
    useEffect(() => {
        ...
        if (player) {
            ...
            player.on('ready', () => setIsPaused(true));
        }
    }, [plyrRef.current]);
    ...
    // صورة المصغرة للفيديو لتكون خلفية الستارة
    ...
    return (
        <div className="secure-plyr-wrapper" style={{ position: 'relative', width: '100%', height: '100%' }}>
            ...
            <style jsx global>{`
                /* إخفاء تفاعل الماوس مع iframe اليوتيوب تماماً (الحماية) */
                ...
                .pause-cover {
                    ...
                    z-index: 60; /* فوق كل شيء ما عدا التحكم */
                ...
                .big-play-btn {
                    ...
                    display: flex; justify-content: center; align-items: center;
                    color: white; font-size: 30px; padding-left: 5px;
                    box-shadow: 0 4px 15px rgba(0,0,0,0.5);
                    transition: transform 0.2s;
                }
                .pause-cover:hover .big-play-btn { transform: scale(1.1); background: #0ea5e9; }
                
                /* رفع أزرار تحكم Plyr لتكون قابلة للضغط */
...
export default function WatchPage() {
    ...
    // ✅ متغير لتحديد هل نحن على موبايل أم كمبيوتر
    ...
    const handleDownloadClick = () => {
        ...
        // التحميل متاح فقط في الوضع Native
    ...
    // ✅ منطق تحديد المشغل النهائي
    // 1. إذا كان كمبيوتر (!isMobile) -> دائماً Plyr (Secure)
    // 2. إذا كان موبايل (isMobile) -> نفحص offline_mode من الـ API
    ...
    return (
        <div className="page-container">
            ...
            {!loading && videoData && (
                <div className="player-wrapper" ref={playerWrapperRef}>
                    ...
                    {shouldUseNativePlayer ? (
                        /* وضع الموبايل الأوفلاين (Native Artplayer) */
                        <NativeArtPlayer 
                            videoData={videoData} 
                            user={user} 
                        ...
                        /* وضع الكمبيوتر أو الموبايل الأونلاين (Plyr + Security) */
            ...
            {/* زر التحميل يظهر فقط في الأندرويد والوضع الأوفلاين */}
            ...
            <style jsx global>{`
                ...
                .player-wrapper { 
                    ...
                    aspect-ratio: 16/9; /* توحيد النسبة 16:9 للجميع */
