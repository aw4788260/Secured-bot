...
export default function WatchPage() {
  ...
  useEffect(() => {
    ...
    // تفعيل Quality Selector بعد تحميل plugin
    if (player.httpSourceSelector) player.httpSourceSelector({ default: 'auto' });
  ...
  return (
    <div className="page-container">
      ...
      <style jsx global>{`
        ...
        .player-wrapper { width: 100%; max-width: 900px; aspect-ratio: 16/9; position: relative; border-radius: 8px; overflow: hidden; box-shadow: 0 10px 30px rgba(0,0,0,0.5); background: #000; }
        .download-button-native { width: 100%; max-width: 900px; padding: 15px; margin-top: 20px; background: #38bdf8; border: none; border-radius: 8px; font-weight: bold; color: #111; cursor: pointer; }
