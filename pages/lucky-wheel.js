  ...
  return (
    <div className="wheel-page">
            ...
            {wheelData.length > 0 ? (
              <div className="roulette-box">
                <Wheel
                  ...
                  textDistance={72}
                />
                {/* ✅ زر المركز بـ z-index منخفض لعدم تغطية نصوص العجلة */}
      ...
      <style jsx>{`
        ...
        /* ✅ FIX: z-index منخفض لعدم تغطية نصوص canvas العجلة */
        .wheel-center-btn {
            position: absolute;
            top: 50%;
            left: 50%;
        ...
        .result-card {
            ...
            margin-top: 20px;
            text-align: center;
            box-shadow: 0 0 40px rgba(220, 167, 66, 0.15);
            animation: fadeInUp 0.5s ease;
        }
        .confetti-emoji { font-size: 3rem; margin-bottom: 5px; animation: bounce 0.6s ease infinite alternate; }
        ...
        /* ✅ صندوق الكوبون */
        .coupon-box { 
            background: rgba(220, 167, 66, 0.07);
            border: 1px dashed rgba(220, 167, 66, 0.5);
            border-radius: 16px;
            padding: 25px 20px;
        }
        .coupon-label { color: #aaaaaa; font-size: 0.95rem; margin: 0 0 15px 0; }
        ...
        .code-display {
            ...
            letter-spacing: 3px;
            text-align: center;
            text-shadow: 0 0 12px rgba(220, 167, 66, 0.5);
        ...
        .validity-note { color: #888888; font-size: 0.85rem; display: block; margin-top: 5px; }
