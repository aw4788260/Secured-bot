...
const BUNNY_STATUS_MAP = {
  0: { code: 'waiting',    label: 'في انتظار المعالجة' },
  1: { code: 'processing', label: 'قيد المعالجة الآن' },
  2: { code: 'processing', label: 'قيد المعالجة الآن' },
  3: { code: 'ready',      label: 'جاهز' },
  4: { code: 'ready',      label: 'جاهز' },
  5: { code: 'failed',     label: 'فشلت المعالجة' },
  6: { code: 'waiting',    label: 'في انتظار المعالجة' },
  7: { code: 'processing', label: 'قيد المعالجة الآن' },
