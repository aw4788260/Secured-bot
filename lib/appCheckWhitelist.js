...
// ولا يمكنها إنتاج App Check token صالح). الأدمن يضيف يدوياً user_id
// الخاص بالمستخدم المتأثر عبر لوحة التحكم (أو استثنائياً اسم المستخدم/
// رقم الهاتف في حالة التسجيل الجديد قبل وجود حساب أصلاً)، وبعدها
// تُقبل طلباته حتى بدون توكن App Check.
//
